...
İletişim bilgileri `assets/data.js` dosyasının sonundaki `ILETISIM` nesnesinde tek yerde durur; üst bant, rapor başlığı, sayfa altı ve kopyalanan metin oradan beslenir. Boş bırakılan alan (örn. `eposta: ""`) hiçbir yerde görünmez.
